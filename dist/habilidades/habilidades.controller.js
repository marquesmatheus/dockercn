...
let HabilidadesController = class HabilidadesController {
    constructor(habilidadesService) {
        ...
        this.genericService = new generic_service_1.GenericService(this.habilidadesService.getinstance());
    }
    async get() {
    ...
    async post(body) {
        return await this.genericService.post(new habilidades_entity_1.Habilidades().init(body));
    }
    async put(body) {
        let habilidades = new habilidades_entity_1.Habilidades().init(body);
...
], HabilidadesController.prototype, "get", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], HabilidadesController.prototype, "getById", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], HabilidadesController.prototype, "post", null);
__decorate([
    (0, common_1.Put)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], HabilidadesController.prototype, "put", null);
__decorate([
...
HabilidadesController = __decorate([
