...
let MembroController = class MembroController {
    constructor(membroService) {
        ...
        this.genericService = new generic_service_1.GenericService(this.membroService.getinstance());
    }
    async get() {
    ...
    async post(body) {
        return await this.genericService.post(new membro_entity_1.Membro().init(body));
    }
    async put(body) {
        let membro = new membro_entity_1.Membro().init(body);
...
], MembroController.prototype, "get", null);
__decorate([
    (0, common_1.Get)('/info'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], MembroController.prototype, "getInfo", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], MembroController.prototype, "getById", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], MembroController.prototype, "post", null);
__decorate([
    (0, common_1.Put)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MembroController.prototype, "put", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], MembroController.prototype, "delete", null);
MembroController = __decorate([
    (0, common_1.Controller)('membro'),
